...
export const MUTATORS: readonly Mutator[] = [
  ...
  { id: 'neblina', nome: 'Neblina', desc: 'Símbolos da 2ª fileira não disparam.', disabledRow: 1 },
  { id: 'sobrecarga', nome: 'Sobrecarga', desc: 'O pulso inicial entra com metade da potência.', potenciaInicial: 0.5 },
