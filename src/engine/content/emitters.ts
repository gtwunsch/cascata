...
export const EMITTERS: readonly EmitterDef[] = [
  {
    ...
    fichasIniciais: 6, maoInicial: ['faisca', 'celula', 'cano'], placementsBase: 3, rows: [1],
  },
  {
    id: 'mk2', nome: 'Emissor MK-2', custoSucata: 40,
    desc: '+1 posicionamento por rodada, mas começa com 3 fichas.',
    fichasIniciais: 3, maoInicial: ['faisca', 'celula', 'cano'], placementsBase: 4, rows: [1],
  },
  {
    id: 'gemeo_e', nome: 'Emissor Gêmeo', custoSucata: 80,
    desc: 'Emite 2 pulsos: fileiras 2 e 3. Mão inicial menor.',
    fichasIniciais: 6, maoInicial: ['faisca', 'cano'], placementsBase: 3, rows: [1, 2],
  },
  {
  ...
  },
  {
    ...
    fichasIniciais: 6, maoInicial: ['faisca', 'celula', 'cano'], placementsBase: 3, rows: [1], lojaExtra: true,
  },
];
